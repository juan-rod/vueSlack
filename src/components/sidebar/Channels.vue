<template>
	<div class="channels_container">
		<h2 class="ui inverted center aligned header">Channels 
			<i class="add square icon add_channels" @click="openChannelModal"></i>
		</h2>
		<div class="ui raised padded segment channels_list">
			<ul>
		...
		<div class="ui basic modal" id="channelModal">
			...
			<div class="actions">
				...
				<div class="ui green ok inverted button" @click="addChannel">
